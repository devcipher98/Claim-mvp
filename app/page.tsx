  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="py-20 bg-red-50 border-y border-red-100">
        <div className="max-w-7xl mx-auto px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            ...
            <div className="bg-white rounded-2xl p-8 border-2 border-red-200 shadow-lg text-center">
              <div className="text-5xl font-bold text-red-700 mb-3">$20B+</div>
              <div className="text-lg text-gray-700 mb-2">Lost annually</div>
              <div className="text-sm text-gray-600">Costing hospitals billions</div>
            </div>
            <div className="bg-white rounded-2xl p-8 border-2 border-red-200 shadow-lg text-center">
      ...
      <div className="py-16 bg-blue-50 border-y border-blue-100">
        <div className="max-w-7xl mx-auto px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Market & Impact</h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto mb-4">
              The U.S. billing and revenue-cycle market <strong>exceeds $20 billion annually</strong>, and it's growing.
            </p>
        ...
        <div className="max-w-6xl mx-auto px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600">
              We bridge hospital pain points and modern AI capabilities — we don't just know the tech; we live the problem.
            </p>
          </div>
          ...
          <div className="bg-gradient-to-r from-blue-50 to-indigo-50 border-2 border-blue-300 rounded-2xl p-8">
            <p className="text-center text-lg text-gray-800 leading-relaxed">
              <strong>Together, we bridge hospital pain points and modern AI capabilities.</strong><br />
              We don't just know the tech; we live the problem.
            </p>
          </div>

          <div className="bg-green-50 border-2 border-green-200 rounded-2xl p-8 mt-8">
      ...
      <div className="py-16 bg-indigo-50 border-y border-indigo-100">
        <div className="max-w-7xl mx-auto px-8">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Why Now?</h2>
            <p className="text-xl text-gray-700 max-w-3xl mx-auto">
              We're at the perfect moment: the tools, the pain, and the market pressure have finally aligned.
            </p>
          </div>
          <div className="grid md:grid-cols-3 gap-8 mb-8">
            <div className="bg-white rounded-2xl p-8 border-2 border-indigo-200 shadow-lg">
              ...
              <h4 className="text-xl font-bold text-gray-900 mb-3">AI Maturity</h4>
              <p className="text-gray-700 leading-relaxed">
                <strong>LLM-based AI agents</strong> can now interpret unstructured clinical text with accuracy once impossible. 
                The technology is finally ready for production healthcare use.
              </p>
            </div>
            <div className="bg-white rounded-2xl p-8 border-2 border-indigo-200 shadow-lg">
              ...
              <h4 className="text-xl font-bold text-gray-900 mb-3">Code Explosion</h4>
              <p className="text-gray-700 leading-relaxed">
                <strong>CPT codes are exploding</strong> — especially with new digital health & AI procedure codes. 
                The complexity is overwhelming manual coders.
                <a 
                  href="https://humanmedicalbilling.com/blog/us-medical-billing-2025-fees-prior-auth-nsa-practical-rcm-playbook" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="block text-sm text-blue-600 mt-2 underline"
                >
                  Source
                </a>
              </p>
            ...
            <div className="bg-white rounded-2xl p-8 border-2 border-indigo-200 shadow-lg">
              ...
              <h4 className="text-xl font-bold text-gray-900 mb-3">Hospital Pressure</h4>
              <p className="text-gray-700 leading-relaxed">
                Hospitals are struggling with <strong>staff shortages and shrinking reimbursements</strong>. 
                The pain is acute and the need for automation is urgent.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-8">
          <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-2xl p-12 border-2 border-green-200 shadow-xl">
            <div className="max-w-3xl mx-auto text-center mb-8">
              <h3 className="text-4xl font-bold text-gray-900 mb-4">Market & Impact</h3>
              <p className="text-lg text-gray-700 mb-6">
                With an average cost of <strong>$172 per bill</strong>, cutting that by half saves tens of millions per hospital system.
              </p>
              <p className="text-base text-gray-600 mb-8">
                For a 500-bed hospital processing 10,000 bills a year, that's <strong className="text-green-700">$860,000 in savings annually</strong> — from a single deployment.
              </p>
            </div>
            
            <div className="bg-white rounded-2xl p-8 border-2 border-green-300 shadow-lg max-w-2xl mx-auto mb-6">
              <div className="text-center mb-6">
            ...
            <div className="bg-white rounded-2xl p-6 border-2 border-blue-300 shadow-lg max-w-xl mx-auto text-center">
              <p className="text-lg text-gray-800 font-semibold mb-2">
                Our model: <strong className="text-blue-700">SaaS subscription + per-claim fee</strong>
              </p>
              <p className="text-base text-gray-600">
                Simple, scalable, and immediately ROI-positive.
              </p>
            </div>
          </div>
        </div>
      ...
      {/* Vision Section */}
      <div className="py-20 bg-gradient-to-br from-indigo-900 via-blue-900 to-purple-900 text-white">
        <div className="max-w-7xl mx-auto px-8">
          <div className="text-center mb-12">
            <h2 className="text-4xl lg:text-5xl font-bold mb-6">Vision</h2>
            <p className="text-2xl lg:text-3xl text-blue-100 mb-8 leading-relaxed max-w-4xl mx-auto">
              Imagine a hospital where every procedure note instantly generates a compliant claim.
            </p>
            <p className="text-xl text-blue-200 mb-4 max-w-3xl mx-auto">
              No denials, no coding backlog, no manual entry — just automatic, accurate billing.
            </p>
          </div>
          
          <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-12 border-2 border-white/20 shadow-2xl max-w-4xl mx-auto text-center">
            <p className="text-3xl lg:text-4xl font-bold mb-4 bg-gradient-to-r from-blue-300 to-indigo-300 bg-clip-text text-transparent">
              "AI Agents as the new billing staff — 
            </p>
            <p className="text-3xl lg:text-4xl font-bold bg-gradient-to-r from-blue-300 to-indigo-300 bg-clip-text text-transparent">
              reclaiming billions for healthcare."
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto px-8">
          <div className="bg-gradient-to-r from-blue-900 via-blue-800 to-indigo-900 rounded-2xl p-12 text-white text-center shadow-2xl">
            ...
            <p className="text-lg text-blue-200 mb-8 max-w-2xl mx-auto">
              We're looking for <strong>mentors, early-pilot partners, and investors</strong> who share our vision 
              to make hospital billing seamless, accurate, and affordable.
            </p>
